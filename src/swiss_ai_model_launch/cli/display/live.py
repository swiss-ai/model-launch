...
from ...launchers.launcher import JobStatus
from ..healthcheck import ModelHealth
...
class _SMLApp(App):  # type: ignore[misc]
    ...
    def on_worker_state_changed(self, event: "App.WorkerStateChanged") -> None:
