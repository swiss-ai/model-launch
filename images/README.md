...
The instructions for building custom container images for the SLURM nodes are available in the [documentation](https://github.com/swiss-ai/documentation/blob/main/pages/custom_container.md#create-a-custom-container-image) repository. Change directory (`cd`) to the desired directory and follow the instructions to build the image. A quick summary of the steps to build the image is as follows:

```bash
cd /desired/directory/containing/dockerfile                                 # change this
