"""Adapted from https://github.com/laude-institute/harbor/blob/main/src/harbor/agents/installed/opencode.py
...
class OpenCode(BaseInstalledAgent):
    ...
    def create_run_agent_commands(self, instruction: str) -> list[ExecInput]:
        ...
        elif provider == "swiss-ai":
            keys.append("SWISS_AI_API_KEY")
        else:
            raise ValueError(
